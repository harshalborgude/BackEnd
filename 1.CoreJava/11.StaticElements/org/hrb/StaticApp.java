...
public class StaticApp{
	...
	public static void main(String[] args) {
	   ...
	   System.out.println("Current obj variable value: "+Obj.getStaticVariable());
	   Obj.setStaticVariable(50);
	   System.out.println("Current obj variable value: "+Obj.getStaticVariable());
	   
	   TestStatic Obj2=new TestStatic();
	   System.out.println("Current obj2 variable value: "+Obj2.getStaticVariable());
